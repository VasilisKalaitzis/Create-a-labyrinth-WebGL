...
<?php
if($_GET['Order']=="Name")
	$result = mysqli_query($con,"SELECT id,stageName,Author,stageLevel,numberOfCheeses,numberOfBuildings FROM stage Order By StageName");
else
	$result = mysqli_query($con,"SELECT id,stageName,Author,stageLevel,numberOfCheeses,numberOfBuildings FROM stage Order By stageLevel");
//SHOW MAPS
...
function ChangePage(PrevOrNext)
{
	...
	if("<?php echo $_GET['Order']; ?>"=="Name") window.location.href = "/cubeGame/chooseMap.php?Order=Name&page="+page;
	else window.location.href = "/cubeGame/chooseMap.php?Order=Map&page="+page;
}
</script>
