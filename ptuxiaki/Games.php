...
?><C><h3><green>GAMES<green></h3> </C> 



<picForGames> &nbsp&nbsp <b> 
	<button id="button" ONCLICK="window.location.href='/cubeGame.php'" onmouseover="" style="cursor: pointer;">1. <b>CUBE GAME</b></button>  </b> <br>  
	<img src="cubeGame.png" style="height:23em; width:13em;" ONCLICK="window.location.href='/cubeGame.php'" onmouseover="this.src='cubeGame2.png'" onmouseout="this.src='cubeGame.png'"></picForGames>
<MessageForGames> 	
					<b> Author: </b> Basilis Kalaitzis
					<br> <b> Description:</b> A small world to track down the 
					<br> cheeses as goal. You can either be the 
					<br> hungry rat who's looking for meal or become
					<br>  the one who creates the world for the other
					<br>  hungry fellows</MessageForGames>
<?php 
